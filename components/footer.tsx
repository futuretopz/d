        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-[15vh] gap-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 lg:gap-24">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="https://www.youtube.com/@zigenterprise" target="_blank" rel="noopener noreferrer" className="text-white/60 text-base hover:text-[#FF4532] hover:translate-x-1 transition-all">
                Youtube
              </a>
            </div>
